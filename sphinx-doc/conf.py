...
# MFD-Cli-client documentation build configuration file, created by
...
htmlhelp_basename = "mfd-cli-client-doc"
...
latex_documents = [
    (master_doc, "mfd-cli-client.tex", "MFD-Cli-client Documentation", "author", "manual"),
]
...
man_pages = [(master_doc, "mfd-cli-client", "MFD-Cli-client Documentation", [author], 1)]
